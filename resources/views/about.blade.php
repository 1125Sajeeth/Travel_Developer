                ...
                <div class="card-body">
                    ...
                    <form id="tourForm" novalidate>
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control fs-5 py-2 px-4 border-secondary" id="name" placeholder="Name" required>
                            ...
                            <div class="border p-3 rounded border-secondary">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex flex-wrap gap-5 ms-2">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input fs-5 border-secondary" type="checkbox" id="place5" value="Jaffna">
